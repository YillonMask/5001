...
scaled_menu_image = pygame.transform.scale(
    menu_background_image, (display_width, display_height)
)
grey = (220, 220, 220)
white = (255, 255, 255)
black = (0, 0, 0)
...
five_dollar_image = pygame.image.load("png/5_chip.png")
scaled_five_image = pygame.transform.scale(five_dollar_image, (150, 150))
ten_dollar_image = pygame.image.load("png/10_chip.png")
scaled_ten_image = pygame.transform.scale(ten_dollar_image, (150, 150))
twentyfive_dollar_image = pygame.image.load("png/25_chip.png")
scaled_twentyfive_image = pygame.transform.scale(twentyfive_dollar_image, (150, 150))
fifty_dollar_image = pygame.image.load("png/50_chip.png")
scaled_fifty_image = pygame.transform.scale(fifty_dollar_image, (150, 150))
hundred_dollar_image = pygame.image.load("png/100_chip.png")
scaled_hundred_image = pygame.transform.scale(hundred_dollar_image, (150, 150))
